  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="group/file relative block w-full cursor-pointer overflow-hidden rounded-lg p-10 glass-dark"
      >
        <input
          ref={fileInputRef}
          ...
          <div className="relative mx-auto mt-10 w-full max-w-xl">
            {files.length > 0 &&
              files.map((file, idx) => (
                <motion.div
                  ...
                  className={cn(
                    "relative z-40 mx-auto mt-4 flex w-full flex-col items-start justify-start overflow-hidden rounded-md glass p-4 md:h-24",
                    "shadow-sm",
                  )}
                >
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  "relative z-40 mx-auto mt-4 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md glass group-hover/file:shadow-2xl",
          ...
          return (
            <div
              ...
              className={`flex h-10 w-10 shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ? "bg-white/5"
                  : "bg-white/5 shadow-[0px_0px_1px_3px_rgba(255,255,255,0.05)_inset]"
              }`}
            />
          );
        }),
